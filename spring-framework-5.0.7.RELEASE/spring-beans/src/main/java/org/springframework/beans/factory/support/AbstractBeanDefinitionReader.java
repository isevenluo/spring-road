...
public abstract class AbstractBeanDefinitionReader implements EnvironmentCapable, BeanDefinitionReader {
	 ...
	 * 
	 * @param registry
	 *            the BeanFactory to load bean definitions into, in the form of a
	 ...
	 * ResourcePatternResolver, the bean definition reader will be capable of
	 * resolving resource patterns to Resource arrays.
	 * <p>
	 ...
	 * evaluating profile information to determine which bean definitions should be
	 * read and which should be omitted.
	 */
	...
	/**
	 * Set the BeanNameGenerator to use for anonymous beans (without explicit bean
	 * name specified).
	 * <p>
	 ...
	 * 
	 * @param location
	 *            the resource location, to be loaded with the ResourceLoader (or
	 *            ResourcePatternResolver) of this bean definition reader
	 * @param actualResources
	 *            a Set to be filled with the actual Resource objects that have been
	 *            resolved during the loading process. May be {@code null} to
	 *            indicate that the caller is not interested in those Resource
	 *            objects.
